...
interface Step2Props {
  ...
  ichiJouhou: string // Add ichiJouhou
  updateIchiJouhou: (value: string) => void // Add update function for ichiJouhou
}
...
export default function Step2ItemLocation({
  ...
  ichiJouhou, // Destructure ichiJouhou
  updateIchiJouhou, // Destructure updateIchiJouhou
}: Step2Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add ichiJouhou input field here */}
      <div className="space-y-2">
